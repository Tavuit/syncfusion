...
export const quickElementsComm = [
  {
    // person with frame
    id: "quickperson",
    title: "Person",
...
export const quickTheoryElements = [
  {
...
export const operatorTheoryElements = [
  {
...
export const allShapes = [].concat(areaData).concat(personData).concat(commLinkData).concat(communicationData).concat(otherData)
  .concat(applicationRects).concat(analysisData).concat(commSignalData).concat(commLabelData).concat(quickElementsComm).concat(systemData).concat(fundamentalData).concat(theoryData)
  .concat(theoryInterface).concat(theorySignals).concat(instrumentData).concat(theoryFunctions).concat(theoryStability).concat(theoryLabel).concat(quickTheoryElements).concat(operatorTheoryElements);
